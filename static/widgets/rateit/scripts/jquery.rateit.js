    ...
    return this.each(function () {
      ...
      if (p1 == "reset") {
        ...
        if (itemdata("backingfld")) {
          ...
          if (
            fld[0].nodeName == "SELECT" &&
            fld[0].getAttribute("data-rateit-valuesrc") === "index"
          ) {
      ...
      if (!itemdata("init")) {
        ...
        var html =
          ...
          (itemdata("readonly") == true ? "" : ' tabindex="0"') +
      ...
      if (isfont) {
        ...
        itemdata(
          "starwidth",
          range.width() / (itemdata("max") - itemdata("min")),
        );
      } else {
